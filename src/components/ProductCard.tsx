    ...
    <div className="card transform hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="p-4 flex flex-col h-72">
        <div className="mb-4">
          ...
          <span className="inline-block px-3 py-1 bg-vintage-paper text-vintage-coffee text-sm mb-2 font-body">
            {product.category.name}
          </span>
          <p className="text-vintage-coffee/80 text-sm h-12 line-clamp-2 font-body">
            {product.description}
          </p>
        </div>
        <div className="mt-auto">
          <div className="text-2xl font-bold text-vintage-sepia mb-3">
            ${product.price}
          </div>
          <div className="flex gap-2">
            ...
            <button
              className="btn bg-vintage-rust text-vintage-cream hover:bg-vintage-gold w-12 flex items-center justify-center text-center"
              title="Cart"
            >
              <svg
