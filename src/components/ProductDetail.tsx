      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <button
            ...
            className="w-full bg-indigo-600 text-white py-4 rounded-lg hover:bg-indigo-700 transition-colors duration-200 flex items-center justify-center text-lg font-medium"
          >
            <svg
